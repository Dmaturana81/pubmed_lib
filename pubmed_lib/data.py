...
# %% auto 0
__all__ = ['DEPARMENT', 'INSTITUTE', 'REMOVE_INSTITUE', 'COUNTRY', 'STATES', 'BR_STATES', 'UNIVERSITY_ABBR',
...
COUNTRY = (
    ('brazil', 'rio de janeiro', 'são paulo', 'porto alegre', 'brasil', 'cordeiropolis', 'florianopolis', 'fortaleza', 'sao paulo', 'belo horizonte', 'uberlandia', 
            'recife'),
    ...
    ('united kingdom', 'u.k.', '\buk\b', 'uk.', 'england', ' uk', 'liverpool', 'london', 'crumpsall', 'leicester', 'manchester', 'cardiff', 'salford', 'bradford', 'oxford', 'clwyd', 'edinburgh', 'edinburge'),
    ('united states of america', 'u.s.a', 'u. s. a.', 'usa', 'united states', 'massachusetts', 'boston', 'howard university', 'torrance', 'san francisco', 'duarte', 'los alamos', 'houston', 'united state', 'california'),
